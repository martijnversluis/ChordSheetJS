...
import {
  ABC, ChordProFormatter, ChordProParser, ChordsOverWordsFormatter, ChordsOverWordsParser, LILYPOND, TAB, TEXTBLOCK,
} from '../../src';
...
Textblock line 2`;
  ...
  it('preserves new_key directives in body content', () => {
    const chordpro = heredoc`
      {title: My Song}
      {key: C}
